...
class dbfuncs:
    ...
    # 'COMPLETEDBUILDS' WEBPAGE

    def completedbuilds(self):  # FUNCTION USED TO RETRIEVE LISTS OF OTHER USERS THAT ARE SET TO PUBLIC.
        sqlstatement = 'SELECT ListName, ListDescr FROM UserSavedLists WHERE PublicOrPrivate = \'1\''
        self.cursor.execute(sqlstatement)
        listinfo = self.cursor.fetchall()
        return listinfo
